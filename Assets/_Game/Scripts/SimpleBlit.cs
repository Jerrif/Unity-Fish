...
At this point, you should see the effect working in the Game-View Tab by dragging the "Cutoff" slider from 0 - 1
(I went nuts because I was expecting it to preview in the Scene view tab; NOT THE CASE!)
...
- "cutoffVal" is a float I defined which I gradually ramp up to 1f in Update or FixedUpdate. This can obviously be changed to anything you want.
For those who are curious, I will include the full modification of the script at the bottom of this comment, but first;

TEXTURE CREATION TIPS =============================
- Create Gradients which go between pure black and Hex-Code "efefef"; I tried making images that went to pure white, and they didn't "complete"
(a part of the screen was left uncovered; feel free to try it with a throw away test to see what I mean)
- You can achieve a LOT of cool effects in Photoshop by using the effects under Filter > Distort on top of simple gradients.
In particular, I recommend messing around with "Ripple", "Twirl", "Wave", and "Zig-Zag"
- One thing which I did frequently was create an image effect which took up half the screen, then copied it to a new layer,
and flipped it to fill the other half of the screen symmetrically
